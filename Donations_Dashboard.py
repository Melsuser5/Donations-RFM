...
df = pd.read_csv('https://raw.githubusercontent.com/Melsuser5/Donations-RFM/main/revised_df_5.csv')
...
df['Segment'] = df['Segment'].replace(segment_names)



fig_all = px.scatter_3d(df, x='recency', y='frequency', z='revenue', color='Segment',width=1600, height=800,hover_data=['customer_no'])
log_fig = px.scatter_3d(df, x='recency', y='frequency', z='revenue', color='Segment', log_x=False,log_y=True,log_z=True, width=1600, height=800,color_continuous_scale=custom_palette,hover_data=['customer_no'])
